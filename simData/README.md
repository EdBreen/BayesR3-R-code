...
The data and information in this directory is from the 14th QTL-MAS workshop 
[http://jay.up.poznan.pl/qtlmas2010/index.html](http://jay.up.poznan.pl/qtlmas2010/index.html). 
It represents simulated geneomic mouse data for public use:
...
##   Genome [164 KB]
 ...
 ## Marker data [./genotypes.txt.gz](./genotypes.txt.gz)
