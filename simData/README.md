The data in this directory is simulated mouse genomic data from the 14th QTL-MAS workshop 
[http://jay.up.poznan.pl/qtlmas2010/index.html](http://jay.up.poznan.pl/qtlmas2010/index.html). 


 Simulated data set

    Pedigree [49.9 KB] [ download ]
    ...
    Marker data [text file - 154 MB] [gziped file - 11 MB]
